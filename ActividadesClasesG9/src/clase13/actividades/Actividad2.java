package clase13.actividades;
import java.util.Random;

public class Actividad2 {
    private static final int SIZE = 6; // Tamaño del tablero 6x6
    private static final int SUBGRID_SIZE_ROW = 2; // Subcuadrante de 2 filas
    private static final int SUBGRID_SIZE_COL = 3; // Subcuadrante de 3 columnas
    ...
    private boolean isValid(int row, int col, int num) {
        ...
        int subGridRow = (row / SUBGRID_SIZE_ROW) * SUBGRID_SIZE_ROW;
        int subGridCol = (col / SUBGRID_SIZE_COL) * SUBGRID_SIZE_COL; // Subcuadrante de 3 columnas
        for (int i = 0; i < SUBGRID_SIZE_ROW; i++) {
            for (int j = 0; j < SUBGRID_SIZE_COL; j++) {
    ...
    public static void main(String[] args) {
        Actividad2 sudoku = new Actividad2();
